                    ...
                    <div class="flex items-center">
                        <div class="shrink-0">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="size-8 text-indigo-500">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M20.25 14.15v4.25c0 1.035-.84 1.875-1.875 1.875H5.625A1.875 1.875 0 013.75 18.4v-4.25m16.5 0a1.875 1.875 0 00-1.875-1.875H5.625a1.875 1.875 0 00-1.875 1.875m16.5 0v-4.25c0-1.035-.84-1.875-1.875-1.875H5.625A1.875 1.875 0 003.75 8.025v4.25m16.5 0a1.875 1.875 0 01-1.875-1.875H5.625a1.875 1.875 0 01-1.875 1.875M12 12v.008H12V12z" />
                            </svg>
                        </div>
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-white/5 hover:text-white" -->
                                <x-nav-link href="/" id="123" :active="request()->is('/')">Home</x-nav-link>
                    ...
                    <div class="hidden md:block">
                        <div class="ml-4 flex items-center md:ml-6">
                            ...
                            <div class="relative ml-3 flex items-center">
                                <img src="https://ui-avatars.com/api/?name=Boh&background=6366f1&color=fff&rounded=true&length=3"
                                    alt="User Avatar"
